...
const DogCareHub = () => {
  ...
  return (
    <section id="care" className="py-20 bg-serenity-gradient">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 fade-in-up">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            <span className="gradient-text">Shih-Tzu</span> Care Hub
          </h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Comprehensive guides and expert advice for every aspect of Shih-Tzu care, from puppyhood to senior years
          </p>
        </div>
        ...
        <div className="text-center mt-16 p-8 rounded-2xl bg-ocean-gradient text-white fade-in-up stagger-5">
          ...
          <p className="text-white/90 mb-6 max-w-lg mx-auto">
            Get access to exclusive Shih-Tzu care content, expert Q&A sessions, and personalized guidance from certified professionals.
          </p>
